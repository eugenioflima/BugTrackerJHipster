package net.kaiel.bugtracker.web.rest;

import static net.kaiel.bugtracker.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import net.kaiel.bugtracker.IntegrationTest;
import net.kaiel.bugtracker.config.Constants;
import net.kaiel.bugtracker.domain.PersistentToken;
import net.kaiel.bugtracker.domain.User;
import net.kaiel.bugtracker.repository.AuthorityRepository;
import net.kaiel.bugtracker.repository.PersistentTokenRepository;
import net.kaiel.bugtracker.repository.UserRepository;
import net.kaiel.bugtracker.security.AuthoritiesConstants;
import net.kaiel.bugtracker.service.UserService;
import net.kaiel.bugtracker.service.dto.AdminUserDTO;
import net.kaiel.bugtracker.service.dto.PasswordChangeDTO;
import net.kaiel.bugtracker.service.dto.UserDTO;
import net.kaiel.bugtracker.web.rest.vm.KeyAndPasswordVM;
import net.kaiel.bugtracker.web.rest.vm.ManagedUserVM;
